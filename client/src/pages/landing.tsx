...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-blue-900 text-white overflow-hidden">
      ...
      <div className="py-12 bg-gradient-to-r from-blue-900/30 via-purple-900/30 to-orange-900/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-8">
            <Link href="/podcast-studio" className="group">
              <div className="bg-gradient-to-br from-green-800/50 to-emerald-800/50 border border-green-500/30 rounded-xl p-6 hover:border-green-400 transition-all transform hover:scale-105 cursor-pointer">
                <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center mb-4 group-hover:bg-green-400 transition-colors">
                  <Mic className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-lg font-bold text-white mb-2">Podcast Studio Pro</h3>
                <p className="text-sm text-gray-300 mb-3">AI transcription, live streaming, social clips automation</p>
                <div className="text-xs text-green-400 font-semibold">→ START PODCASTING</div>
              </div>
            </Link>
            ...
            <Link href="/social-media-deployment" className="group">
              <div className="bg-gradient-to-br from-orange-800/50 to-red-800/50 border border-orange-500/30 rounded-xl p-6 hover:border-orange-400 transition-all transform hover:scale-105 cursor-pointer">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Social AI Team</h3>
                <p className="text-sm text-gray-300 mb-3">5 AI agents for TikTok, Instagram, YouTube growth</p>
                <div className="text-xs text-orange-400 font-semibold">→ GO VIRAL</div>
              </div>
            </Link>

            <Link href="/genre-remixer" className="group">
              <div className="bg-gradient-to-br from-cyan-800/50 to-blue-800/50 border border-cyan-500/30 rounded-xl p-6 hover:border-cyan-400 transition-all transform hover:scale-105 cursor-pointer">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Genre Remixer AI</h3>
                <p className="text-sm text-gray-300 mb-3">Cross-genre collaboration and remix opportunities</p>
                <div className="text-xs text-cyan-400 font-semibold">→ REMIX NOW</div>
              </div>
            </Link>
          </div>
        </div>
